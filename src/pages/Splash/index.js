		...
		<div>
			...
			<div className='splashContent'>
				<div className='splashBody'>
					...
					can be captured from any selection of the content or you can use the round
					clipboard button on the right to copy the whole snippet. <br />
					<br />
					...
					<br />
					<br />
					To get started, register or log in from the navbar at the top of the page;
					you will also have a profile associated with your account, which you can
					always access from the icon in the top right corner. <br />
				</div>
				<br />
				<br />
				<HighlightableButton title='proceed' />
			</div>
		</div>
	);
}
